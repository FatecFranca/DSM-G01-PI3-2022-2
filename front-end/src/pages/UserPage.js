...
import Modal from '../components/ModalAvaliation/Index';
// components
    ...
    <>
      ...
      <Container>
        <Stack direction="column" alignItems="left" justifyContent="space-between" mb={5}>
          ...
          <Typography variant="h3" gutterBottom sx={{marginLeft: "40%"}} >
            Projeto
          </Typography>
      ...
      {isModalOpen && <Modal open={isModalOpen} onClose={() => setIsModalOpen(false)} id={idUser} />}
    </>
  );
